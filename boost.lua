...
-- Hashing
local hasher = not isStudio and loadstring(game:HttpGet("https://raw.githubusercontent.com/Reload-astro/menu-lib/refs/heads/main/hasher.lua"))()["hasher"] --or require(script.Parent.ModuleScript)['hasher']
